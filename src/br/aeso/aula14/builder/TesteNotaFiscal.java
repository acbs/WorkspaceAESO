...
public class TesteNotaFiscal {
	...
	public static void main(String[] args) {
		...
		List<ItemDaNota>itens = Arrays.asList(new ItemDaNota("item 1", 200.0), new ItemDaNota("item 2", 100.0));
		...
		NotaFiscal nf = new NotaFiscal(emitente, razaoSocial, cnpj, dataEmissao, valorBruto, impostos, itens, observacoes);
